...
The samplers were tested against a benchmark composed of 218 models encoded as Boolean formulas (CNFs, BDDs, and SDDs). Nine of the 218 models represent configurable software systems. The remaining models are industrial SAT formulas (mostly modeling integrated circuits) that are typically used as a benchmark in the SAT-sampling literature [@Chakraborty15; @Achlioptas18; @Plazar19].
