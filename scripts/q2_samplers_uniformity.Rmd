...
For the extreme cases, where $P(x)$ or $Q(x)$ are equal to zero, the directions given by [Drost(2018)](https://cran.r-project.org/web/packages/philentropy/index.html) are followed to compute a numercially stable Kullback–Leibler divergence.
